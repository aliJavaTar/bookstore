...
<div align="center">
    ...
    <form action="update_book" method="post" enctype="multipart/form-data" onsubmit="return validateFormInput()">
        <table class="form">
            ...
            <tr>
                ...
                <td align="left"><input type="text" id="title" name="title" size="20" value=<%=book.getTitle()%>></td>
            </tr>
            <br>
            <tr>

                <td align="right">Author:</td>
                <td align="left"><input type="text" id="author" name="author" size="20" value=<%=book.getAuthor()%>></td>
                <br>
            </tr>
            <tr>
                <td align="right">price:</td>
                <td align="left"><input type="number" id="price" name="price" size="20" value=<%=book.getPrice()%>></td>
            </tr>

            <tr>
                <td align="right">isbn:</td>
                <td align="left"><input type="text" id="isbn" name="isbn" size="20" value=<%=book.getIsbn()%>></td>
            </tr>

            <tr>
                <td align="right">publish_date:</td>
                <td align="left"><input type="date" id="publish_date" name="publish_date" size="20" value=<%=book.getPublish_date()%>></td>
            </tr>

            <tr>
                <td align="right">Book Image :</td>
                <td align="left"><input type="file" id="image" name="image" size="20" value=<%=book.getImage()%> ></td>
            ...
            <tr>
                ...
                <td align="left"><textarea id="description" name="description" size="20" value=<%=book.getDescription()%>></textarea></td>
            </tr>
            <tr>
