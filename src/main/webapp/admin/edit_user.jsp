...
<div class="form-style-10">
    ...
    <form>
        ...
        <div class="inner-wrap">
            <label>Your Full Name <input type="text" name="fullName" value=<%=user.getFullName()%>/></label>
        ...
        <div class="inner-wrap">
            <label>Password <input type="password" name="password" valuevalue=<%=user.getPassword()%> /></label>
