<header align="center">
    ...
    <div style="margin: 32px auto; display: flex; justify-content: center;" >
        <div style="margin: 0 16px;">
            <a href="user_list" style="color: black; text-align: center; vertical-align: baseline; text-decoration: none;">
                <i class="fas fa-user-tie fa-3x" style="display: block;"></i>
                <div style="font-size: large; margin-top: 4px">Users</div>
            </a>
        </div>
        <div style="margin: 0 16px;">
            <a href="list_category" style="color: black;text-align: center;vertical-align: baseline; text-decoration: none;">
